...
| 2026-09-22 | README "What you'll need" review | [#22](https://github.com/ianktoo/data-forge/issues/22) | No generic OpenAI-compatible local endpoint support (LM Studio, Lemonade, vLLM) — only Ollama | open |
