...
| 2026-09-22 | 2.4.3 stability check | [#53](https://github.com/ianktoo/data-forge/issues/53) | No-sitemap crawl only follows links in the main content, so it misses site navigation | this fix |
