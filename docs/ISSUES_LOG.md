...
| 2026-09-22 | 2.4.3 release check | [#51](https://github.com/ianktoo/data-forge/issues/51) | Release binaries overwrote each other: no macOS binary, ambiguous names | this fix |
