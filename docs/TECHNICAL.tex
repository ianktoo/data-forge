...
depth and page count, which follows every same-domain link on a page
(site navigation included), queuing links in the main content first so
that a tight page budget favours article pages. The same fallback applies
