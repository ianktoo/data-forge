...
(\texttt{dataforge scrape}) in place of URLs: its pages are stored as the
session's collection, without being fetched again, and the run starts at
processing.
...
assumed to hold uniformly once established for one.
